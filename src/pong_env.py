...
class PongEnv(gym.Env):
    ...
    def _get_observation(self):
        ...
        obs = np.array(
            [current_ball_pos[0], current_ball_pos[1], ball_dx, ball_dy, self.player_paddle.rect.centery], dtype=np.float32
        )
    ...
    def step(self, action):
        self.step_count += 1
        self.player_paddle.direction = {0: 0, 1: -1, 2: 1}[action]  # Stay  # Up  # Down
